...
public:
    ...
    System(field_container_t x0, field_container_t v0, real_t t0, field_value_t field_zero, real_t real_zero) :
        ...
        if (x.size() != v.size())
            throw SizeMismatchException("System(field_container_t, field_container_t)");
...
private:
    ...
    integrator_t<field_container_t, field_value_t, real_t, System, step_handler_t> integrator;
};
