...
class unary_system : public generic_system<field_value_t, real_t, integrator_t, step_handler_t, unary_system<field_value_t, real_t, integrator_t, step_handler_t>> {
public:
