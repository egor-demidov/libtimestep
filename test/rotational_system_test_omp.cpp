...
class RotationalGranularSystem : public rotational_binary_system_omp<Eigen::Vector3d, double, rotational_velocity_verlet_half, rotational_step_handler, RotationalGranularSystem, false> {
public:
    RotationalGranularSystem(double k, double g, double r, double m, double gamma_c,
            ...
            rotational_binary_system_omp<Eigen::Vector3d, double, rotational_velocity_verlet_half, rotational_step_handler, RotationalGranularSystem, false>(std::move(x0), std::move(v0),
