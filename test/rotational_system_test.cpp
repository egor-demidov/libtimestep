...
class RotationalGranularSystem : public RotationalSystem<Eigen::Vector3d, double, rotational_velocity_verlet_half, rotational_step_handler> {
public:
    RotationalGranularSystem(double k, double g, double r, double m, double gamma_c,
        ...
        RotationalSystem<Eigen::Vector3d, double, rotational_velocity_verlet_half, rotational_step_handler>(std::move(x0), std::move(v0),
